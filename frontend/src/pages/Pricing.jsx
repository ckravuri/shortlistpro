  ...
  const tiers = [
    {
      ...
      features: [
        ...
        { text: '3 PDF exports/month', included: true },
        { text: 'Resume upload (PDF/DOCX)', included: false },
        { text: 'ATS score history', included: false },
        { text: 'STAR Builder', included: false },
        { text: 'Job Ad Generator', included: false },
        { text: 'Headshot Generator', included: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'STAR Format Builder', included: true },
        { text: 'Job Ad Generator', included: true },
        { text: 'Headshot Generator', included: false },
